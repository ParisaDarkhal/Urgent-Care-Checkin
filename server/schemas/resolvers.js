...
// Reschedule an appoitment
        ...
        updateAppointmentMa: (_, { appointmentId, appt_time }) => { 
            const appointment = find(appointment, { id: appointmentId }); 
            if (!appointment) {
              throw new Error(`Couldn’t find author with id ${appointmentId}`);
            }
