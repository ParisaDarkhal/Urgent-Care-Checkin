        ...
        <div className="row">
          <div className="col-lg-4 mr-auto col-sm-6">
            <div className="widget mb-5 mb-lg-0">
              ...
              <p className="p-4">
                We are committed to the health and wellness of our community. As
                such, we dedicate ourselves to being a center of excellence in
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="widget widget-contact mb-5 mb-lg-0">
              ...
              <div className="footer-contact-block">
                ...
                <h4 className="mt-2">+233-456-6588</h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-lg-6">
              <div className="copyright fs-5">
                Developed with ♡ by {" Marjorie, Elizabetta and Parisa!"}
              </div>
            </div>
            <div className="col-lg-6">
