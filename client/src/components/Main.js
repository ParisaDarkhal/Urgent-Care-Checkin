              ...
              <div className="col-lg-6 col-md-12 col-xl-7">
                <div className="block">
                  ...
                  <span className="text-uppercase text-sm letter-spacing ">
                    We staff our clinics to keep your wait times down because we
                    care about your time.
                  </span>
                  <h1 className="mb-3 mt-3">
                    Your most trusted health partner
                  </h1>
                  <p className="mb-4 pr-5">Walk-in any time, 365 days a year</p>
              ...
              <div className="col-lg-12">
                <div className="feature-block d-lg-flex">
                  <div className="feature-item mb-5 mb-lg-0">
                    ...
                    <h4 className="mb-3">Need to cancel your appoinment?</h4>
                    <p className="mb-4">
                      Check-In below to let us know when you would like to be
                      seen
                    </p>
                    <Link
